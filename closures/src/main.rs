...
impl Inventory {
    fn giveaway(&self, user_preference: Option<ShirtColor>) -> ShirtColor {
        // here unwrap_or_else takes one arg: a closure w/o any args
        // the closure expression: "|| self.most_stocked()"
...
fn main() {
    ...
    // Annotating the types for a closure would look like:
    ...
    // compiler closure type inference
